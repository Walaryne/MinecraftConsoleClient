...
namespace MinecraftClient.Mapping.BlockPalettes
{
    ...
    public class Palette115 : BlockPalette
    {
        ...
        static Palette115()
        {
            ...
            for (var i = 1345; i <= 1346; i++)
                materials[i] = Material.TallSeagrass;
            for (var i = 1347; i <= 1358; i++)
                materials[i] = Material.Piston;
            for (var i = 1359; i <= 1382; i++)
            ...
            for (var i = 7866; i <= 7871; i++)
                materials[i] = Material.CutRedSandstoneSlab;
            for (var i = 7872; i <= 7877; i++)
